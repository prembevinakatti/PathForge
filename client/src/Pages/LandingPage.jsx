...
const Logo = () => (
  <div className="flex items-center gap-2">
    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#D4AF37] to-[#B9962E] flex items-center justify-center shadow-md">
      <span className="text-white font-extrabold text-base tracking-widest">PF</span>
    </div>
  ...
  return (
    <div className="min-h-screen w-full bg-[#FAF7F0] text-[#5C4B3B] flex flex-col relative overflow-hidden">
      ...
      <nav className="relative z-10 w-full py-3 px-10 flex justify-between items-center bg-white/40 backdrop-blur-md border-b border-[#EADFC8]">
        ...
        <div className="flex items-center gap-5 text-sm font-medium text-[#A68B6F]">
          <a className="hover:text-[#5C4B3B] transition">Features</a>
          <a className="hover:text-[#5C4B3B] transition">Roadmaps</a>
          <button className="bg-gradient-to-r from-[#D4AF37] to-[#B9962E] px-4 py-1.5 rounded-md text-white font-semibold hover:opacity-90">
            Login
          </button>
        </div>
      </nav>
      ...
      <main className="relative z-10 px-10 mt-20 flex flex-col md:flex-row items-center justify-between gap-14 max-w-6xl mx-auto text-center md:text-left">
        ...
        <div className="flex flex-col items-center md:items-start">
          ...
          >
            PathForge creates personalized 6-month learning paths with milestones,
            skills, and curated resources to guide your career toward your dream role.
          </motion.p>
      ...
      <section className="relative z-10 mt-24 grid grid-cols-1 md:grid-cols-3 gap-12 max-w-6xl mx-auto pb-24 px-10">
        ...
        {[
          { icon: Compass, title: "AI-Generated Path", desc: "Instant personalized roadmaps based on your goals." },
          { icon: Layers, title: "Weekly Milestones", desc: "Structured checkpoints designed for real progress." },
          { icon: Target, title: "Skill-Focused Learning", desc: "Learn exactly what your dream job requires." }
          ...
          <motion.div
            ...
            style={{
              borderImage: "linear-gradient(135deg, #D4AF37 0%, #B9962E 100%) 1",
            }}
          >
            <Icon className="text-[#D4AF37] w-14 h-14 mb-4 drop-shadow-sm" />
            <h3 className="text-2xl font-bold text-[#5C4B3B] mb-2 drop-shadow-sm">{title}</h3>
      ...
      <footer className="relative z-10 bg-white/40 py-2 px-10 border-t border-[#EADFC8] text-xs backdrop-blur-md">
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <Logo />
          <p className="text-[#A68B6F]">© {new Date().getFullYear()} PathForge</p>
        </div>
      </footer>
